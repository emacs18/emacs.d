...
(
 ...
 ("sm-my" . ((user-emacs-directory . "~/.emacs.d/sm-my/")
            (env . (("SPACEMACSDIR" . "~/.emacs.d/sm-my/.spacemacs")))))
 ("sm-straight" . ((user-emacs-directory . "~/.emacs.d/sm-straight/")
             (env . (("SPACEMACSDIR" . "~/.emacs.d/sm-straight/.spacemacs")))))
